//! Стрес-тесты для проверки производительности и
//! стабиоьности под нагрузкой. Запускаются отдельно
...
proptest! {
    ...
    /// Стрес-тест: 10 тыс. случаных roundtrips должны завершиться быстро.
    #[test]
