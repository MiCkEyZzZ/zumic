...
//! установки целочисленных значений по ключу.
...
///
/// # Возвращает
/// Новое значение после увеличения, либо ошибку, если значение не является целым числом.
#[derive(Debug)]
...
/// Команда INCRBY — увеличивает целочисленное значение по ключу на заданное число.
///
...
///
/// # Возвращает
/// Новое значение после уменьшения, либо ошибку, если значение не является целым числом.
#[derive(Debug)]
...
/// Команда DECRBY — уменьшает целочисленное значение по ключу на заданное число.
///
