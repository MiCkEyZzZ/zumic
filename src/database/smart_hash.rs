//! SmartHash — это адаптивная структура, похожая на хеш-таблицу,
//! оптимизированная для коллекций небольшого и среднего размера.
//!
...
//!
//! Структура автоматически переключается между этими представлениями
//! в зависимости от количества элементов для повышения производительности
