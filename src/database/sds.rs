...
//! которая использует стек (stack) для коротких строк и кучу (heap) для
//! длинных, обеспечивая компактность и высокую производительность. Структура
//! автоматически переключается между двумя режимами хранения в зависимости от
//! длины строки.
...
mod tests {
    ...
    /// Тест проверяет переход от стека к куче при добавлении байта,
    /// превышающего лимит.
    #[test]
