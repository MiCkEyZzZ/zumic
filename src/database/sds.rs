//! Модуль `Sds` реализует структуру данных, которая представляет
//! собой строку, с оптимизированным хранением для малых и больших
//! строк, использующих стек для небольших строк и кучу для длинных
//! строк.
