...
mod tests {
    ...
    /// Тест проверяет кодирование InlineString в байтовый поток.
    /// Проверяет, что строка "OK" правильно кодируется в формат
    /// "+OK\r\n".
    #[test]
    ...
    /// Тест проверяет кодирование BinaryString в байтовый поток.
    /// Проверяет, что строка "hello" правильно кодируется с
    /// длиной и содержимым.
    #[test]
    ...
    /// Тест проверяет кодирование вложенного массива.
    /// Проверяет, что массив из двух элементов (строка и число)
    /// правильно кодируется.
    #[test]
    ...
    /// Тест проверяет кодирование неверного InlineString.
    ...
    /// Тест проверяет кодирование пустого словаря.
    ...
    /// Тест проверяет кодирование словаря с одним элементом.
    /// Проверяет, что словарь с одним элементом кодируется
    /// корректно.
    #[test]
    ...
    /// Тест проверяет кодирование словаря с некорректным значением.
    /// Проверяет, что в словарь могут быть добавлены только
    /// валидные строки.
    #[test]
    ...
    /// Тест проверяет кодирование неполного словаря.
    /// Проверяет, что даже неполный словарь с одним элементом
    /// корректно кодируется.
    #[test]
    ...
    /// Тест проверяет кодирование отрицательного числа с плавающей
    /// запятой.
    #[test]
    ...
    /// Тест проверяет кодирование булевого значения `true`.
    /// Проверяет, что `ZspFrame::Bool(true)` кодируется как "#t\r\n".
    #[test]
    fn test_bool_true() {
    ...
    /// Тест проверяет кодирование булевого значения `false`.
    /// Проверяет, что `ZspFrame::Bool(false)` кодируется как "#f\r\n".
    #[test]
    fn test_bool_false() {
